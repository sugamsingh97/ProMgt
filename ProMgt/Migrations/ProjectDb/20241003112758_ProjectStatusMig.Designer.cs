...
namespace ProMgt.Migrations.ProjectDb
{
    ...
    [Migration("20241003112758_ProjectStatusMig")]
    partial class ProjectStatusMig
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ProMgt.Data.Project", b =>
                {
                    ...
                    b.Property<int?>("ProjectStatusId1")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ProMgt.Data.ProjectTask", b =>
                {
                    b.HasOne("ProMgt.Data.Priority", "Priority")
                        .WithOne("ProjectTask")
                        .HasForeignKey("ProMgt.Data.ProjectTask", "PriorityId");
                    ...
                    b.HasOne("ProMgt.Data.TaskStatus", "TaskStatus")
                        .WithOne("ProjectTask")
                        .HasForeignKey("ProMgt.Data.ProjectTask", "TaskStatusId");
